<template>
    ...
    >
      <v-list>
        ...
        <v-subheader class="red darken-4 white--text">Pai</v-subheader>
        <v-list-item-content>
          <form-pessoa
            :pessoa="obj.pai"
            ref="formPai"
        ...
        <v-subheader class="red darken-4 white--text">Mãe</v-subheader>
        <v-list-item-content>
          <form-pessoa
            :pessoa="obj.mae"
            ref="formPessoa"
        ...
        <v-subheader class="red darken-4 white--text">Responsável</v-subheader>
        <v-list-item-content>
          <form-pessoa
            :pessoa="obj.responsavel"
            ref="formResponsavel"
          />
        </v-list-item-content>
        ...
        <v-list-item-content>
          <form-endereco
            :endereco="obj.responsavel.endereco"
            ref="formResposavelEndereco"
          />
        </v-list-item-content>
